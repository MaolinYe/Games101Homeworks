...
Eigen::Vector3f texture_fragment_shader(const fragment_shader_payload &payload) {
    ...
    for (auto &light: lights) {
        ...
        Eigen::Vector3f specular =
                ks.array() * light.intensity.array() / r.dot(r) * std::max(0.f, std::pow(normal.dot(h), p));
...
int main(int argc, const char **argv) {
    ...
    bool loadout = Loader.LoadFile(
            "C:\\Users\\v_maolinye\\CLionProjects\\Games101Homeworks\\Assignment3\\Code\\models\\spot\\spot_triangulated_good.obj");
